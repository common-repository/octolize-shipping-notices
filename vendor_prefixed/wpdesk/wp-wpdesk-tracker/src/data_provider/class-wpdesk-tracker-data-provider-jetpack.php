...
if (!\class_exists('OctolizeShippingNoticesVendor\WPDesk_Tracker_Data_Provider_Jetpack')) {
    ...
    class WPDesk_Tracker_Data_Provider_Jetpack implements \WPDesk_Tracker_Data_Provider
    {
        ...
        public function get_data()
        {
            ...
            $data['jetpack_connected'] = \class_exists('OctolizeShippingNoticesVendor\Jetpack') && \is_callable('OctolizeShippingNoticesVendor\Jetpack::is_active') && Jetpack::is_active() ? 'yes' : 'no';
            $data['jetpack_is_staging'] = \class_exists('OctolizeShippingNoticesVendor\Jetpack') && \is_callable('OctolizeShippingNoticesVendor\Jetpack::is_staging_site') && Jetpack::is_staging_site() ? 'yes' : 'no';
