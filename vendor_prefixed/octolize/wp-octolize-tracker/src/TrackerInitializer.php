...
use OctolizeShippingNoticesVendor\WPDesk\Tracker\PluginActionLinks;
/**
...
class TrackerInitializer implements HookableCollection
{
     ...
     */
    public static function create_from_plugin_info(\OctolizeShippingNoticesVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
     ...
     * @return TrackerInitializer
     */
    public static function create_from_plugin_info_for_shipping_method(\OctolizeShippingNoticesVendor\WPDesk_Plugin_Info $plugin_info, string $shipping_method_id, ReasonsFactory $reasons_factory = null)
    {
        $shops = $plugin_info->get_plugin_shops();
        $shop_url = $shops[get_locale()] ?? $shops['default'] ?? 'https://octolize.com';
