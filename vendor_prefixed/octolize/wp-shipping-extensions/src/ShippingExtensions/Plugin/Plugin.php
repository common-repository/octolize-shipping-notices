...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'octolize-shipping-notices') : __('Buy plugin →', 'octolize-shipping-notices');
    }
}
